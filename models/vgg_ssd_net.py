...
def net_conf(mode):
    ...
    img = paddle.layer.data(
        ...
        type=paddle.data_type.dense_vector(
            cfg.IMG_CHANNEL * cfg.IMG_HEIGHT * cfg.IMG_WIDTH),
    ...
    loc_filter_size, conf_filter_size = get_loc_conf_filter_size(
        len(CONV4_PB.ASPECT_RATIO), len(CONV4_PB.MIN_SIZE),
        len(CONV4_PB.MAX_SIZE))
    conv4_3_norm_mbox_loc, conv4_3_norm_mbox_conf = mbox_block(
        "conv4_3_norm", conv4_3_norm, 512, 3, loc_filter_size,
        conf_filter_size)
